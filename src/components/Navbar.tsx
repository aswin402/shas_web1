    ...
    <>
      ...
      >
        ...
        <div className="border-b border-border/40">
          <div className="max-w-[1400px] mx-auto flex items-center justify-between h-16 md:h-[88px] section-padding">
            {/* Logo */}
            <Link
              to="/"
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          />
          <div className="absolute top-[100px] md:top-[127px] right-0 w-full sm:w-80 h-[calc(100dvh-100px)] md:h-[calc(100dvh-127px)] bg-white border-l border-border overflow-y-auto">
